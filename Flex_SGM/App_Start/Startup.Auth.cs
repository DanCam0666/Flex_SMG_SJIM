...
namespace Flex_SGM
{
    public partial class Startup
    {
        ...
        {
            // Configure el contexto de base de datos, el administrador de usuarios y el administrador de inicios de sesión para usar una unica instancia por solicitud

    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
			...
			bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include(
				//"~/Scripts/jquery-{version}.js", // Ensure jQuery comes first
                "~/Scripts/moment-with-locales.js", // Load moment.js before datetimepicker
                ...
                //"~/Addon/DatetimePicker/bootstrap-datetimepicker.min.js" // Ensure this is after moment.js
            ));

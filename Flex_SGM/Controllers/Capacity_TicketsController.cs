...
{
    public class Capacity_TicketsController : Controller
    {
        ...
        // GET: Capacity_Tickets
        public async Task<ActionResult> Index()
        {
            var metricos = db.Metricos.ToList<Metricos>();
            var validMetricosRecords = metricos.Where(m => m.Usuario_area is "Capacity_Tickets" && m.DiaHora.Year == DateTime.Now.Year).ToList();
            var users = validMetricosRecords.Where(m => m.Usuario_area is "Capacity_Tickets")
            ...
            var chartLabel = metricos
                .Where(m => m.Usuario_area is "Capacity_Tickets")
                .Where(m => m.DiaHora.Year == DateTime.Now.Year)
                .GroupBy(m => m.Usuario_responsable)
                .Select(m => m.Key)
                .ToList();
        ...
        // GET: Capacity_Tickets/Details/5
        ...
        // POST: Capacity_Tickets/Delete/5

...
{
    public class Yellow_SheetsController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var chartData1 = metricos
                .Where(m => m.Usuario_area is "Yellow_Sheets")

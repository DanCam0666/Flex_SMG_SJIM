...
{
    public class Quality_HSController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var validMetricosRecords = metricos.Where(m => m.Usuario_area is "Quality_HS" && m.DiaHora.Year == DateTime.Now.Year).ToList();

...
{
    public class PPAPsController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var validMetricosRecords = metricos.Where(m => m.Usuario_area is "PPAPs" && m.DiaHora.Year == DateTime.Now.Year).ToList();
            var users = validMetricosRecords.Where(m => m.Usuario_area is "PPAPs")
            ...
            var chartLabel = metricos
                .Where(m => m.Usuario_area is "PPAPs")
                .Where(m => m.DiaHora.Year == DateTime.Now.Year)
                .GroupBy(m => m.Descripcion)
                .Select(m => m.Key)
                .ToList();

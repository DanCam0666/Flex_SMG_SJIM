...
namespace Flex_SGM.Controllers
{
    ...
    public class OILsController : Controller
    {
            ...
            c1=false,bool c2 = false, bool c3 = false, bool c4 = false, bool c5 = false, bool c6 = false,string area= "",string btn="")
        {
            ...
            Urgente = 0; NoReali = 0; Fechaprox = 0; ConFecha = 0; sinfecha = 0; realizada = 0;
            foreach (OILs oil in oILs.Where(s => (s.User_res == "Yolanda Vianney Hurtado Ayala" || s.User_asig == "Yolanda Vianney Hurtado Ayala")).ToList())
            {
                if (oil.Estatus == 1)
                    realizada++;
                if (oil.Estatus == 2)
            ...
            ViewBag.vHrealizada = realizada;
            ViewBag.vHActivos =  NoReali + sinfecha + Urgente + Fechaprox + ConFecha ;

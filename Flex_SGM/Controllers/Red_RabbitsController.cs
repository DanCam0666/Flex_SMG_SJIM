...
{
    public class Red_RabbitsController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            var validMetricosRecords = metricos.Where(m => m.Usuario_area is "Red_Rabbits").ToList();
            var users = validMetricosRecords.Where(m => m.Usuario_area is "Red_Rabbits")
            ...
            var chartLabel = metricos
                .Where(m => m.Usuario_area is "Red_Rabbits")
                .Where(m => m.DiaHora.Year == DateTime.Now.Year)
                .GroupBy(m => m.Usuario_responsable)
                .Select(m => m.Key)
                .ToList();
